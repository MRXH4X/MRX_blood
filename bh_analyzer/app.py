...
<title>MRX Blood // Attack Path Analyzer</title>
...
<header>
  <div class="logo" style="display:flex;align-items:center;gap:10px">
    ...
    <span>MRX <span style="color:var(--dim2);font-weight:400">//</span> <span style="font-size:.7em;letter-spacing:2px;color:var(--green)">BLOOD</span></span>
  </div>
  ...
  <main>
    ...
    <div class="content" id="content">
      <div class="welcome">
        ...
        <div class="w-title">MRX BLOOD</div>
        <div class="w-sub">Load the BloodHound ZIP<br>Mark the owned accounts<br>Attack paths update immediately<br><span style="color:var(--cyan);font-size:.85em">Ready to analyze...</span></div>
      </div>
    </div>
...
async function loadZip(file) {
  ...
  try {
    ...
    alert('Connection error: ' + e.message + '\nIs the server running? (mrxblood)');
  }
}
